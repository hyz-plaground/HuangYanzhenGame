...
public class EventCenterManager : Singleton<EventCenterManager>
{
    ...
    /// <param name="action">绑定action。此处action为函数所在对象的某一对改事件有所反应的函数。</param>
    /// <example> EventCenterManager.Instance.AddEventListener&lt;bool&gt;(GameEvent.YOUR_EVENT, YourFunction); </example>
    ...
    /// </summary>
    /// <param name="eventName">事件名</param>
    /// <param name="action">此处action为函数所在对象的某一对改事件有所反应的函数。</param>
